...
window.onload = getContent("morning_azkar.json", morningContent);
window.onload = getContent("evening_azkar.json", eveningContent);
window.onload = getContent("salah_azkar.json", salahContent);
